...
#writeLines("<meta property='og:title' content='Applying a bayesian workflow: lessons from Statistical Rethinking (I)'/>
#<meta property='og:image' content='https://raw.githubusercontent.com/bennywee/house_prices_kaggle/master/blog/9r_posterior_predictive_check_outcomescale.png'/>
#<meta property='og:description' content='A modelling workflow in Stan, Python and R'/>
#<meta property='og:url' content='https://bennywee.github.io/assets/posts/applying_a_bayesian_workflow_pt1_post.html'/>", fileConn)
#close(fileConn)
```
